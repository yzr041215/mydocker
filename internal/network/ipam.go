...
const ipamDefaultAllocatorPath = "/var/run/mydocker/network/subnet.json"
...
func (ipam *IPAM) load() error {
	...
	//fmt.Println("load subnet allocation info")
	// 读取文件，加载配置信息
...
func (ipam *IPAM) dump() error {
	ipamConfigFileDir := path.Dir(ipam.SubnetAllocatorPath)
